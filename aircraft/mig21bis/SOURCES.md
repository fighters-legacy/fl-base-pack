...
| `[aero.moments]` | Tail arms/areas published (F13-TD) but derivatives are not | **E** inputs → **D** derivatives, DATCOM methods; signs/magnitudes checked as on previous aircraft |
